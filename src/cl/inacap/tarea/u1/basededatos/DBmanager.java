...
public class DBmanager {
	 ...
	 // columna tabla relacion
	   ...
	   public DBmanager(Context context)
	   {
		   ...
		   /* datos insertados la primera vez que corrimos la aplicacion luego 
		    * 
		    * y queremos logearnos luego cerramos y comentamos para correr de nuevo la 
		    * aplicacion
		    *
		 	
		    db.execSQL("insert into "+ DATABASE_TABLA1 +" values('juan','juan','juan')");
		   	db.execSQL("insert into "+ DATABASE_TABLA1 +" values('test','test','test')");
		   	db.execSQL("insert into "+ DATABASE_TABLA2 +" values('10000999-9','DANIEL FUENTES','PICARTE 1092','(63) 2 343434')");
		   	db.execSQL("insert into "+ DATABASE_TABLA2 +" values('11000999-8','IGNACIO PEREZ','PICARTE 3000','(63) 2 989898')");
		   */
	   }
	   ...
	   public void insertar_cliente(String id_cliente, String nombre_cliente, String direccion, String telefono  )
	   {
		   	// consulta que almacena los datos
		   	db.execSQL("insert into " + DATABASE_TABLA2 + " values('"+id_cliente+"','"+nombre_cliente+"','"+ direccion +"','"+ telefono +"')");
